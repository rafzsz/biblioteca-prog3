export const WelcomeComponent = {
    template: `
<div class="relative min-h-screen flex flex-col sm:justify-center items-center bg-local bg-cover" style="background-image: url(https://i.pinimg.com/originals/f5/05/f5/f505f5040274b97cd5114f9ff3ab8b99.jpg)">
    <p class="italic text-red-600 font-mono text-7xl text-center ...">
    <h1>Sua Biblioteca</h1>
    </p>
    <p class="text-4xl text-center text-yellow-50"><br>Acesse a sua listagem de livros: </p><br><br><br>    
    <router-link to="/List">
        <div class=" flex itens-center justify-center">
            <button type="button"
                class="font-mono flex itens-center rounded-full py-3 px-6 bg-gradient-to-r from-green-400 to-blue-500 hover:from-pink-500 hover:to-yellow-500 ...">
                Meus Livros &nbsp;
