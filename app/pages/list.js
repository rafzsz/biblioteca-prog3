export const ListComponent = {
    ...
    <div class="min-w-screen min-h-screen bg-gray-200 flex items-center justify-center bg-gray-100 font-sans overflow-hidden bg-gradient-to-r from-blue-200 via-purple-300 to-yellow-400">
